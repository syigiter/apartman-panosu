...
const layouts = [
  { x: 18, y: 34, w: 14, h: 146, mx: 7, my: 20, mw: 43, mh: 156, r: -7, cr: 1.6, sx: 2, sy: -2, tr: 2, z: 12 },
  { x: 39, y: 37, w: 16, h: 136, mx: 46, my: 31, mw: 44, mh: 148, r: 2, cr: -1.2, sx: -2, sy: 2, tr: -4, z: 16 },
  { x: 64, y: 27, w: 13, h: 168, mx: 16, my: 47, mw: 39, mh: 166, r: -3, cr: 2.4, sx: 3, sy: 2, tr: 8, z: 10 },
  { x: 22, y: 60, w: 15, h: 176, mx: 49, my: 54, mw: 41, mh: 168, r: 5, cr: -2.1, sx: -3, sy: -2, tr: -7, z: 14 },
  { x: 51, y: 58, w: 14, h: 184, mx: 8, my: 64, mw: 40, mh: 174, r: -4, cr: 1.2, sx: 1, sy: 3, tr: 4, z: 9 },
  { x: 71, y: 45, w: 12, h: 168, mx: 51, my: 67, mw: 36, mh: 160, r: 8, cr: -2.8, sx: -2, sy: 1, tr: -10, z: 11 },
  { x: 29, y: 25, w: 13, h: 140, mx: 10, my: 76, mw: 38, mh: 150, r: 6, cr: 2.2, sx: 2, sy: 2, tr: 7, z: 8 },
  { x: 44, y: 66, w: 15, h: 156, mx: 47, my: 78, mw: 42, mh: 156, r: -6, cr: -1.8, sx: -1, sy: -2, tr: -5, z: 7 },
];

const localLayouts = [
  { x: 36, y: 42, w: 15, h: 146, mx: 9, my: 21, mw: 42, mh: 154, r: -3, cr: 1.4, sx: 1, sy: -2, tr: 3, z: 18 },
  { x: 54, y: 51, w: 14, h: 160, mx: 47, my: 33, mw: 39, mh: 160, r: 4, cr: -1.5, sx: -2, sy: 2, tr: -5, z: 17 },
  { x: 29, y: 59, w: 15, h: 142, mx: 13, my: 47, mw: 41, mh: 148, r: 2, cr: 2, sx: 2, sy: 1, tr: 6, z: 16 },
  { x: 68, y: 36, w: 12, h: 168, mx: 51, my: 53, mw: 36, mh: 166, r: -5, cr: -2, sx: -1, sy: 3, tr: -8, z: 15 },
];
        ...
        {boardPosts.map((post, index) => {
          ...
          return (
            <article
              ...
              className={`board-note-position paper-note realistic-note ${attachment} ${style.shape} ${style.shell} paper-shadow border p-3 transition duration-200 md:p-3.5 ${isActive ? "scale-[1.012]" : "hover:scale-[1.008]"}`}
              style={noteVars}
            >
              <span className="paper-tape" aria-hidden="true" />
